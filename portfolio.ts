...
export const openSource = {
  githubUserName: "deepakpanda22",
};

export const contact = {};

export const socialLinks: SocialLinksType = {
  email: "mailto:deepakpanda282@gmail.com",
  linkedin: "https://www.linkedin.com/in/deepak030399/",
  github: "https://github.com/deepakpanda22",
  instagram: "https://www.instagram.com/life_of_deep",
};
  ...
  data: [
    {
      ...
      skills: [
        emoji("⚡ Building responsive Single-Page-Apps (SPA) & PWA in React.js or Angular"),
      ],
      softwareSkills: [
        {
          skillName: "Angular",
        ...
        {
          skillName: "Azure",
          iconifyTag: "logos:MicrosoftAzure",
        },
        {
          skillName: "Github",
